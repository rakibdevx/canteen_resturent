...
Route::prefix('admin')->middleware(RedirectIfNotAdmin::class)->group(function () {
    ...
    Route::middleware(CheckRoleAdmin::class)->group(function () {
        ...
        Route::get('address', [AdminAddressController::class, 'index'])->name('admin.addresses.index');
        Route::post('address/store', [AdminAddressController::class, 'store'])->name('admin.addresses.store');
        Route::post('address/update/{id}', [AdminAddressController::class, 'update'])->name('admin.addresses.update');
        Route::post('address/delete/{id}', [AdminAddressController::class, 'destroy'])->name('admin.addresses.destroy');
